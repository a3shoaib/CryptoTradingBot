...
# Creating balance class with dictionary being the key and the balance object will be the value
# Will prevent from having to keep looking at documentation. Doing same with other classes
...
class Candle:
    def __init__(self, candle_info, timeframe, exchange):
        ...
        # Need another case for when the candle comes from the parse_trades() method
...
class Contract:
    def __init__(self, contract_info, exchange):
        if exchange == "binance":
            ...
            # price_decimals and quantity_decimals are used to round the price/quantity of the order to a decimal that
            # binance accepts
...
class Trade:
    def __init__(self, trade_info):
        ...
        self.side: str = trade_info['side'] # Long or short
